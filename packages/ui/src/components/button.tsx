...
const buttonVariants = cva(
  "stt-inline-flex stt-items-center stt-justify-center stt-rounded-md stt-text-sm stt-font-medium stt-ring-offset-background stt-transition-colors focus-visible:stt-outline-none focus-visible:stt-ring-2 focus-visible:stt-ring-ring focus-visible:stt-ring-offset-2 disabled:stt-pointer-events-none disabled:stt-opacity-50",
  {
    variants: {
      variant: {
        default: "stt-bg-primary stt-text-primary-foreground hover:stt-bg-primary/90",
        destructive: "stt-bg-destructive stt-text-destructive-foreground hover:stt-bg-destructive/90",
        outline: "stt-border stt-border-input hover:stt-bg-accent hover:stt-text-accent-foreground",
        secondary: "stt-bg-secondary stt-text-secondary-foreground hover:stt-bg-secondary/80",
