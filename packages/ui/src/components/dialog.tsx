...
const DialogHeader: Component<ComponentProps<"div">> = (props) => {
  ...
  return (
    <div class={cn("stt-flex stt-flex-col stt-space-y-1.5 stt-text-center sm:stt-text-left", props.class)} {...rest} />
  )
}
...
const DialogFooter: Component<ComponentProps<"div">> = (props) => {
  ...
  return (
    <div
      class={cn("stt-flex stt-flex-col-reverse sm:stt-flex-row sm:stt-justify-end sm:stt-space-x-2", props.class)}
      {...rest}
    />
  )
}
...
const DialogTitle = <T extends ValidComponent = "h2">(
  ...
  return (
    <DialogPrimitive.Title
      class={cn("stt-text-lg stt-font-semibold stt-leading-none stt-tracking-tight", props.class)}
      {...rest}
    />
  )
}
